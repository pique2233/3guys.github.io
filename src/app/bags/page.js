...
const CLOTHING_CONFIG = {
  banners: [1, 2, 3].map(num => `/images/bags/banner-${num}.jpg`),
  sections: {
    zh: [
      { 
        title: '当季流行服饰',
        images: Array.from({length: 8}, (_, i) => `/images/bags/regular-${i+1}.jpg`)
      },
      {
        title: '设计师联名系列',
        images: Array.from({length: 8}, (_, i) => `/images/bags/designer-${i+1}.jpg`)
      }
    ],
    en: [
      { 
